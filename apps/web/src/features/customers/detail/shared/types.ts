...
export type EmailDraftAttachment = { id: string; fileAssetId: string; filename: string; mimeType?: string | null; sizeBytes?: number | null; sortOrder: number };
export type EmailDraft = { id: string; quoteId?: string; quoteSnapshot?: { quoteNo?: string; productName?: string; currency?: string; amount?: string }; purpose?: string; subject: string; body: string; toEmail: string; toNameSnapshot?: string; fromEmailSnapshot?: string; fromNameSnapshot?: string; status: string; emailAccountId?: string; emailAccount?: EmailAccount; customer?: { id?: string; name: string }; attachments?: EmailDraftAttachment[]; aiGenerationRun?: AiRun; updatedAt: string };
